      ...
      () => {
        this.setState(
          ...
          () => {
            this.setState(
              {
                startindex: this.state.lastindex - 4,
              },
              () => {
      ...
      <div className="list-container">
        <div className="body">
          {this.state.limitnews.map((item) => {
            return (
              <div key={item.id} className="row" onClick={() => this.props.showModelHandler(true)}>
                <div className="details">
                  ...
                  <div className="info">
                    ...
                    <div className="news">{`${item.body.slice(0, 75)}  ...`}</div>
                    <div className="date">{moment(new Date()).format("llll")}</div>
                  </div>
                </div>
                <div className="btn-container" onClick={(e) => e.stopPropagation()}>
                  <div className="cancel-btn" onClick={(e) => this.deleteNewsHandler(item.id)}>
                    <p>X</p>
                  </div>
                </div>
              </div>
        ...
        <div className="footer">
          <div className="btns">
            ...
            <div className={`btn-1 ${this.state.startindex === 4 ? "active-btn" : null}`} onClick={() => this.pageHandler(2)}>
              2
            </div>
            <div className={`btn-1 ${this.state.startindex === 8 ? "active-btn" : null}`} onClick={() => this.pageHandler(3)}>
              3
            </div>
            {this.state.lastindex < 12 ? (
